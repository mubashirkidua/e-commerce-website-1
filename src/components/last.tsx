          ...
          <div className="flex-grow flex flex-wrap justify-center md:justify-start md:pr-20 -mb-10 text-center md:text-left">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Kids&rsquo; Shoes</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Kids&rsquo; Jordan Shoes</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Kids&rsquo; Basketball Shoes</a>
                </li>
              </nav>
            </div>
          </div>
